...
export async function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative py-20 px-6 pb-40 bg-transparent z-0"
    >
      {/* Absolute gradient overlay exactly covering the bottom half of the last section */}
      <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-linear-to-b from-transparent to-secondary/30 dark:to-background pointer-events-none -z-10" />
